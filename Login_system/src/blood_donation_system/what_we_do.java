...
JLabel jlb13=new JLabel("Blood donors are essential to the blood supply. America's Blood Centers and our member");
...
donor_info();
 ...
 void label()
     {
     jlb1.setFont(font1);
 jlb1.setBounds(0,200,2000,50);
 jlb1.setForeground(Color.RED);
 panel.add(jlb1);

 jlb2.setBounds(0,220,2000,50);
 panel.add(jlb2);
 ...
 void label2()
     {
 jlb3.setFont(font1);
 jlb3.setBounds(0,260,2000,50);
 jlb3.setForeground(Color.red);
 panel.add(jlb3);
 
 jlb4.setBounds(0,280 ,2000,50);
 panel.add(jlb4);

 jlb5.setBounds(0,300,2000,50);
 panel.add(jlb5);

 jlb6.setBounds(0,320,2000,50);
 panel.add(jlb6);
 jlb7.setBounds(0,340,2000,50);
 panel.add(jlb7);

 jlb8.setBounds(0,360,2000,50);
 panel.add(jlb8);


 jlb9.setBounds(0,380,2000,50);
 panel.add(jlb9);
 }
...
void donor_info()
     {
jlb15.setFont(font1);
jlb15.setBounds(0,420,2000,20);
panel.add(jlb15);

jlb16.setFont(font1);
jlb16.setBounds(0,440,2000,20);
jlb16.setForeground(Color.RED);
panel.add(jlb16);


jlb13.setBounds(0,460,2000,20);
panel.add(jlb13);

jlb13.setBounds(0,480,2000,20);
panel.add(jlb13);
jlb14.setBounds(0,500,2000,20);
panel.add(jlb14);
}
